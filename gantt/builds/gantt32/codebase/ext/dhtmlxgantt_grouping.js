...
this.relation_property=t,this.group_id=e,this.group_text=n},group_tasks:function(t,e,n,i,a){this.update_settings(n,i,a);var s=this.generate_data(t,e);this.loaded=s.data.length,t._clear_data(),t.parse(s)}},t._groups.init(t),t.groupBy=function(t){t=t||{};var e=t.groups||null,n=t.relation_property||null,i=t.group_id||"key",a=t.group_text||"label";this._groups.group_tasks(this,e,n,i,a)}});
