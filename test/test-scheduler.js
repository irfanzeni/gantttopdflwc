...
glob("./test/scheduler/pdf/*.json", function(e, files){ run_tests(files, "pdf") });
glob("./test/scheduler/excel/*.json", function(e, files){ run_tests(files, "excel") });
glob("./test/scheduler/ical/*.json", function(e, files){ run_tests(files, "ical") });
glob("./test/scheduler/png/*.json", function(e, files){ run_tests(files, "png") });
